 ...
 * @author comp1
 */
public class CadQuestion extends javax.swing.JFrame {

    /**
     * Creates new form CadQuestion
     */
    public CadQuestion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadQuestion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadQuestion().setVisible(true);
            }
        });
    }
